...
<div>
    ...
    <div class="flex justify-between items-center mt-6 mr-2 lg:mt-9 xl:mt-11">
        ...
        <a href="/test.pdf" aria-label="View my resume"><Button variant="primary" size="sm" class="sm:h-7 sm:px-4 sm:text-base sm:gap-2"><span>Resume</span><Icon name="arrow-up-right" class="w-2 h-2 sm:w-3 sm:h-3"/></Button></a>
    </div>
</div>
